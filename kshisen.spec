...
Source0  : https://download.kde.org/stable/release-service/20.04.2/src/kshisen-20.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.04.2/src/kshisen-20.04.2.tar.xz.sig
...
%prep
%setup -q -n kshisen-20.04.2
cd %{_builddir}/kshisen-20.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591894487
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kshisen-20.04.2/COPYING %{buildroot}/usr/share/package-licenses/kshisen/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/kshisen-20.04.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/kshisen/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
%find_lang kshisen
