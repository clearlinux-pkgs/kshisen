...
Source0  : https://download.kde.org/stable/release-service/23.04.1/src/kshisen-23.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.1/src/kshisen-23.04.1.tar.xz.sig
...
%prep
%setup -q -n kshisen-23.04.1
cd %{_builddir}/kshisen-23.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685597469
mkdir -p clr-build
pushd clr-build
