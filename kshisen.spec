...
Version  : 22.12.0
Release  : 45
URL      : https://download.kde.org/stable/release-service/22.12.0/src/kshisen-22.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.0/src/kshisen-22.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.0/src/kshisen-22.12.0.tar.xz.sig
...
%prep
%setup -q -n kshisen-22.12.0
cd %{_builddir}/kshisen-22.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670518668
mkdir -p clr-build
pushd clr-build
