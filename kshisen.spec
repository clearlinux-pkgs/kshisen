...
Version  : 23.04.3
Release  : 54
URL      : https://download.kde.org/stable/release-service/23.04.3/src/kshisen-23.04.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.3/src/kshisen-23.04.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.3/src/kshisen-23.04.3.tar.xz.sig
...
%prep
%setup -q -n kshisen-23.04.3
cd %{_builddir}/kshisen-23.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1688844313
mkdir -p clr-build
pushd clr-build
